...
namespace Lab9._1b
{
    class Program
    {
        ...
        {
            List<Telecast> table = new List<Telecast>();
           List<Log> log = new List<Log>();
            ...
            string PathTextFile = @"C:\Users\alisa\source\repos\Lab9\Lab9.1b\lab.dat";
            ...
            do
            {
                ...
                switch (option)
                {
                    ...
                    case 4:
                        ...
                        table.Insert(iForEdit-1, EditTelecast);
